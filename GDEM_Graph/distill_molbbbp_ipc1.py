...
parser.add_argument('--ratio_k', type=float, default=0.0)
parser.add_argument('--alpha', type=float, default=0.1)
parser.add_argument('--beta', type=float, default=1e-06)
parser.add_argument('--gamma', type=float, default=0.5)
parser.add_argument('--e1', type=int, default=15)
parser.add_argument('--e2', type=int, default=20)
parser.add_argument('--lr_eigenvec', type=float, default=0.0001)
...
parser.add_argument('--nconvs', type=int, default=5)
